...
- 📱 **移动端全面支持** - 响应式布局、底部工具栏、虚拟键盘、触摸手势（单击/双击/长按/捏合缩放）、iOS 适配
...
- 🔧 **自适应 SHA-256** - HTTPS 环境使用原生 crypto.subtle（无开销），HTTP 环境使用本地 sha256.min.js 库并提示安全风险
...
- 底部工具栏提供"操作权"、"画质"、"键盘"、"截图"、"连接"功能
- 虚拟键盘支持 Fn 行、方向键、组合键（Ctrl+C/V/Z/A/Del）和 Win 键
- 触摸手势：单击=左键、双击=连续左键、长按=右键、双指捏合=滚轮/缩放
